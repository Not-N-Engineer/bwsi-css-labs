...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 7, -3) == 10   # Test for negation of negative
    assert simple_calculator("subtract", -3, 7) == -10  # Test for one negative number
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", -4, -6) == 24  # Test for two neggative numbers
...
def test_division():
    ...
    assert simple_calculator("divide", -4, -6) == 0.6666666666666666  # Test for two negative numbers
